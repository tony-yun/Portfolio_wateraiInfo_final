...
/**
 * the textinput form (in SignUpScreen and SignInScreen)
 * @type {string} placeholder
 * @type {boolean} isUsername
 * @type {boolean} isEmail
 * @type {boolean} isPhonenumber
 * @type {boolean} isPassword
 * @type {boolean} isVerifyPassword
 * @returns input value
 */
const InputForm = ({
  placeholder,
